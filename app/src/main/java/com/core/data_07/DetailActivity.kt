...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val product = intent.getSerializableExtra(PHOTO) as Product?
        ...
        //
        product?.cost.let {
            val textView: TextView = findViewById(R.id.cost_detail_3) as TextView
        ...
        //
        product?.tags.let {
            val textView: TextView = findViewById(R.id.cost_detail_4) as TextView
