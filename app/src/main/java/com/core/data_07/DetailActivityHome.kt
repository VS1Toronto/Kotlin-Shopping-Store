...
class DetailActivityHome : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //
        val imageView = findViewById(R.id.imageView_5) as ImageView
        val product = intent.getSerializableExtra(PHOTO) as ProductHome?
        ...
        //
        product?.cost.let {
            val textView: TextView = findViewById(R.id.cost_detail_9) as TextView
        ...
        //
        product?.tags.let {
            val textView: TextView = findViewById(R.id.cost_detail_10) as TextView
