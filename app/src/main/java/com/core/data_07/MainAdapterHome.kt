 ...
 */
class MainAdapterHome(var productHome:List<ProductHome>, var clickListener : View.OnClickListener) : RecyclerView.Adapter<MainAdapterHome.PhotoHolder>() {

    override fun getItemCount(): Int {
        return productHome.size      //  Returns number of photos we currently have
    }

    override fun onBindViewHolder(holder: PhotoHolder, position: Int) {
        val product = productHome[position]                             //  Get the photo at the given position
    ...
    //
    fun getProducts(adapterPosition : Int) : ProductHome {
        return productHome[adapterPosition]
    }
