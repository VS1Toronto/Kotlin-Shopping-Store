...
class DetailActivityBoysWear : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail_boys_wear)
        ...
        //
        val imageView = findViewById(R.id.imageView_3) as ImageView
        val product = intent.getSerializableExtra(PHOTO) as ProductBoysWear?
        ...
        //
        product?.cost.let {
            val textView: TextView = findViewById(R.id.cost_detail_5) as TextView
        ...
        //
        product?.tags.let {
            val textView: TextView = findViewById(R.id.cost_detail_6) as TextView
