 ...
 */
class ProductMensWearRetreiver  {

    private val service: ProductMensWearAPI
    ...
    init {
        ...
        //
        service = retrofit.create(ProductMensWearAPI::class.java)
    }
    ...
    //
    fun getProducts(callback : Callback<ProductMensWearList>) {
