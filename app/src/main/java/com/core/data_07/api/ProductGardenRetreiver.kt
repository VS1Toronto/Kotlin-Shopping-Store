 ...
 */
class ProductGardenRetreiver {

    private val service: ProductGardenAPI
    ...
    init {
        ...
        //
        service = retrofit.create(ProductGardenAPI::class.java)
    }
    ...
    //
    fun getProducts(callback : Callback<ProductGardenList>) {
