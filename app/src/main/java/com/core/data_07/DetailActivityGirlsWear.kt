...
class DetailActivityGirlsWear : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail_girls_wear)
        ...
        //
        val imageView = findViewById(R.id.imageView_4) as ImageView
        val product = intent.getSerializableExtra(PHOTO) as ProductGirlsWear?
        ...
        //
        product?.cost.let {
            val textView: TextView = findViewById(R.id.cost_detail_7) as TextView
        ...
        //
        product?.tags.let {
            val textView: TextView = findViewById(R.id.cost_detail_8) as TextView
