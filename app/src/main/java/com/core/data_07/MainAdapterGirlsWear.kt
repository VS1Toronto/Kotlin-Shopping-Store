 ...
 */
class MainAdapterGirlsWear(var productGirlsWear:List<ProductGirlsWear>, var clickListener : View.OnClickListener) : RecyclerView.Adapter<MainAdapterGirlsWear.PhotoHolder>() {

    override fun getItemCount(): Int {
        return productGirlsWear.size      //  Returns number of photos we currently have
    }

    override fun onBindViewHolder(holder: PhotoHolder, position: Int) {
        val product = productGirlsWear[position]                        //  Get the photo at the given position
    ...
    //
    fun getProducts(adapterPosition : Int) : ProductGirlsWear {
        return productGirlsWear[adapterPosition]
    }
