...
class DetailActivityMensWear : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail_mens_wear)
        ...
        //
        val imageView = findViewById(R.id.imageView_1) as ImageView
        val product = intent.getSerializableExtra(PHOTO) as ProductMensWear?
        ...
        //
        product?.cost.let {
            val textView: TextView = findViewById(R.id.cost_detail_1) as TextView
        ...
        //
        product?.tags.let {
            val textView: TextView = findViewById(R.id.cost_detail_2) as TextView
