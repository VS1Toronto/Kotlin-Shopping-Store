 ...
 */
class MainAdapterGarden(var productGarden:List<ProductGarden>, var clickListener : View.OnClickListener) : RecyclerView.Adapter<MainAdapterGarden.PhotoHolder>() {

    override fun getItemCount(): Int {
        return productGarden.size      //  Returns number of photos we currently have
    }

    override fun onBindViewHolder(holder: PhotoHolder, position: Int) {
        val product = productGarden[position]                           //  Get the photo at the given position
    ...
    //
    fun getProducts(adapterPosition : Int) : ProductGarden {
        return productGarden[adapterPosition]
    }
